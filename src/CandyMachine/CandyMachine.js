...
const CandyMachine = ({ walletAddress, candyMachine, setCandyMachine }) => {
  useEffect(() => {
      ...
      state: {
        ...
        (presale || candyMachine.data.goLiveDate.toNumber() < new Date().getTime() / 1000) &&
            (candyMachine.endSettings
              ...
              : true),
        goLiveData: candyMachine.data.goLiveDate,
  ...
  //     await getAtaForMint(mint.publicKey, walletAddress)
  //   )[0];
  
  //   const userPayingAccountAddress = candyMachine.state.tokenMint
  //     ? (await getAtaForMint(candyMachine.state.tokenMint, walletAddress))[0]
  //     : walletAddress;
